...
<body>
            ...
            <div style="display:flex; flex-direction: row; justify-content:space-between;">
                ...
                <ul style="display:flex; justify-content:space-between; list-style-type: none; font-family: sans-serif; font-weight: bold;">
                    <li><span>
                        ...
                        <span> | </span>
                        <span>
                            <a href="index.php?authorization=no" style="text-decoration: none; color: black;">Выйти</a>
                        </span>
                    </li>
                </ul>
            </div>
    ...
    <?php endif;?>
    <p style="display:inline-block; padding-left: 30px;font-weight: bold; font-size: 20px; font-family: sans-serif; color: gray">Главная</p>
</body>
</html>
